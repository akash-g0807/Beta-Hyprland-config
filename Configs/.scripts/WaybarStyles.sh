...
if [ "$X_MODE" == "dark" ] ; then
	waybar_styles="$HOME/.config/waybar/dark_styles"
	waybar_style="$HOME/.config/waybar/dark.css"
else
	waybar_styles="$HOME/.config/waybar/light_styles"
	waybar_style="$HOME/.config/waybar/light.css"
fi
